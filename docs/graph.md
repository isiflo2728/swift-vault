...
(function () {
  const nodes = [
    ...
    { id: "MapKit",             type: "concept", url: "../concepts/maps-location/" },
    { id: "MapReader",          type: "concept", url: "../concepts/maps-location/" },
    ...
    { id: "TabView",                    type: "concept", url: "../concepts/navigation/" },
    { id: "UNUserNotificationCenter",   type: "concept", url: "../projects/hot-prospects/" },
    { id: ".swipeActions",              type: "concept", url: "../concepts/layouts-lists/" },
    { id: "Timer (Combine)",            type: "concept", url: "../projects/flashzilla/" },
    { id: "scenePhase",                 type: "concept", url: "../concepts/state-data-flow/" },
    { id: "allowsHitTesting",           type: "concept", url: "../projects/flashzilla/" },
    { id: "accessibilityDifferentiateWithoutColor", type: "concept", url: "../concepts/accessibility/" },
    { id: "GeometryReader",         type: "concept", url: "../concepts/layouts-lists/#geometryreader" },
    { id: "rotation3DEffect",       type: "concept", url: "../concepts/layouts-lists/#scroll-driven-effects" },
  ...
  const links = [
    ...
    { source: "BucketList", target: "@Observable" },
    { source: "BucketList", target: "@State" },
    { source: "BucketList", target: "Sheet" },
    { source: "BucketList", target: "URLSession" },
    { source: "BucketList", target: "Codable" },
    { source: "BucketList", target: "async/await" },
    { source: "BucketList", target: "MapKit" },
    { source: "BucketList", target: "MapReader" },
    { source: "BucketList", target: "Annotation" },
    ...
    { source: "HotProspects", target: "TabView" },
    { source: "HotProspects", target: "SwiftData" },
    { source: "HotProspects", target: "@Query" },
    { source: "HotProspects", target: "@Environment" },
    { source: "HotProspects", target: "@AppStorage" },
    { source: "HotProspects", target: "#Predicate" },
    { source: "HotProspects", target: "SortDescriptor" },
    { source: "HotProspects", target: "NavigationStack" },
    { source: "HotProspects", target: "Sheet" },
    { source: "HotProspects", target: "List" },
    { source: "HotProspects", target: "CIFilter" },
    { source: "HotProspects", target: "CIContext" },
    { source: "HotProspects", target: "ShareLink" },
    { source: "HotProspects", target: "UNUserNotificationCenter" },
    { source: "HotProspects", target: ".swipeActions" },

    { source: "FlashZilla", target: "@State" },
    { source: "FlashZilla", target: "@Environment" },
    { source: "FlashZilla", target: "Sheet" },
    { source: "FlashZilla", target: "NavigationStack" },
    { source: "FlashZilla", target: "List" },
    { source: "FlashZilla", target: "DragGesture" },
    { source: "FlashZilla", target: "UserDefaults" },
    { source: "FlashZilla", target: "Codable" },
    { source: "FlashZilla", target: ".accessibilityLabel" },
    { source: "FlashZilla", target: ".accessibilityHidden" },
    { source: "FlashZilla", target: "Timer (Combine)" },
    { source: "FlashZilla", target: "scenePhase" },
    { source: "FlashZilla", target: "allowsHitTesting" },
    { source: "FlashZilla", target: "accessibilityDifferentiateWithoutColor" },

    { source: "LayoutandGeometry", target: "ScrollView" },
    { source: "LayoutandGeometry", target: "GeometryReader" },
    { source: "LayoutandGeometry", target: "rotation3DEffect" },
    { source: "LayoutandGeometry", target: "visualEffect" },
